def add_time(start, duration, *day):
    ...
    #####  calculating starting minutes and duration minutes
    start_in_minutes = int(start_m) + (int(start_h) * 60)
    # print('start_in_minutes:', start_in_minutes)
    ...
    def week_day(d):
        ...
        if d:
            ...
            idx = [i for i, n in enumerate(week) if n == d]  # List comprehension
            if idx:
                idx = idx[0]
            else:
                idx = 0
            # print('idx:', idx)  # index of the current day
            ...
            # print('n_day_idx:', n_day_idx)  # index of the future day
